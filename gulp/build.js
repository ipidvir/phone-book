...
gulp.task('template', function () {
    return gulp.src([appDir +'/tmpl_html/*.htm'])
        .pipe(gulp.dest(destDir + '/tmpl_html'))
});
...
gulp.task('build', function (cb) {
    runSequence(['img', 'css', 'html', 'json', 'template','bower_components', 'templateCache', 'build-es6'], 'injects', cb);
});
